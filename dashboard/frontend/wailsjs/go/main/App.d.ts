...
export function ClearPersistedSecret(arg1:string):Promise<string>;

export function ClearPersistedSecrets():Promise<string>;

export function ConnectLinkedInSession():Promise<string>;
...
export function VerifySingleCredential(arg1:string,arg2:string):Promise<Record<string, string>>;
